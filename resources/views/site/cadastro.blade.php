    ...
    <div class="login-content">
        <form action="{{ route('cadastro.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-div one">
                ...
                <div class="div">
                    <input type="text" name="nomeUsuarioRegistro" id="nomeUsuario" class="input" placeholder="Nome Completo" required>
                </div>
            </div>
            ...
            <div class="input-div one">
                ...
                <div class="div">
                    <input type="email" class="input" name="emailUsuarioRegistro" id="emailUsuarioRegistro" placeholder="Email" required>
                </div>
            </div>
            <div class="input-div one">
                <div class="i">
                ...
                <div class="div">
                    <input type="text" class="input" name="telefoneUsuarioRegistro" id="telefoneUsuario" placeholder="Telefone" required>
                </div>
            </div>
            <div class="input-div one">
                <div class="i">
