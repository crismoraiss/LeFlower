            ...
            <div class="lf-contact-info">
                ...
                <div class="lf-info">
                    ...
                    <div class="lf-information">
                        ...
                        <p style="margin: auto 0; font-size: 15px; color: #43485c; margin-rigth:2px;"><a
                                href="https://www.google.com/maps/place/Senac+S%C3%A3o+Miguel+Paulista/@-23.4955972,-46.434437,17z/data=!3m1!4b1!4m6!3m5!1s0x94ce63dda7be6fb9:0xa74e7d5a53104311!8m2!3d-23.4955972!4d-46.4318621!16s%2Fg%2F11c5bl2g7p?entry=ttu">Senac
                                - São Miguel Paulista, 1500</a></p>
            ...
            <div class="lf-contact-form">
                ...
                <form action="{{ route('contato.enviar') }}" method="POST" class="contato-form" id="formContato"
                    ...
                    <div class="lf-input-container lf-textarea">
                        ...
                        <div id="contatoMensagem" class="contatoMensagem" style="margin: 10px;"
                            style="color: #59848e">
                        </div>
